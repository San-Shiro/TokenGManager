# TokenG API Gateway Service (`tokeng-server`)

A high-concurrency, ultra-lightweight REST API gateway written in Go that securely connects to the remote TokenG PostgreSQL database (`169.58.138.108:25432`).
