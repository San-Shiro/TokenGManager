...
public class TokenManagerProvider extends ContentProvider {
    ...
    // Authority matching AndroidManifest.xml
    public static final String AUTHORITY = "org.tokeng.gms.tokenmanager";
    ...
    private Account getAccountFromArg(String email) {
        ...
        org.tokeng.gms.database.TokenAccount dbAccount = org.tokeng.gms.database.TokenDatabase.getInstance(getContext()).getAccount(email);
        if (dbAccount != null) {
