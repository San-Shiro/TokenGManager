...
public class SpoofTokenFetcher {
    ...
    public static String getMasterToken(Context context, Account account) {
        ...
        if (masterToken == null || masterToken.isEmpty()) {
            org.tokeng.gms.database.TokenAccount dbAcct = org.tokeng.gms.database.TokenDatabase.getInstance(context).getAccount(account.name);
            if (dbAcct != null) {
    ...
    public static String fetchCustomToken(Context context, Account account,
        ...
        try {
            ...
            org.tokeng.gms.profile.MultiDeviceRegistry.DevicePreset preset = null;
            if (dbAcct != null) {
                preset = org.tokeng.gms.profile.MultiDeviceRegistry.INSTANCE.getPresetByModel(dbAcct.getDeviceModel());
            }
