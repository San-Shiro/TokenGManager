...
package org.tokeng.gms.checkin;

import org.microg.gms.checkin.CheckinRequest;
import org.microg.gms.checkin.CheckinResponse;

import static org.tokeng.gms.checkin.CheckinPreferences.isSpoofingEnabled;
...
import org.tokeng.gms.auth.AuthRequest;
import org.microg.gms.common.Constants;
import org.microg.gms.common.DeviceConfiguration;
import org.microg.gms.common.Utils;
import org.tokeng.gms.gservices.GServices;
...
public class CheckinManager {
    ...
    @SuppressWarnings("MissingPermission")
    public static synchronized LastCheckinInfo checkin(Context context, boolean force, org.tokeng.gms.profile.MultiDeviceRegistry.DevicePreset preset) throws IOException {
        ...
        try {
            List<org.tokeng.gms.database.TokenAccount> dbAccounts = org.tokeng.gms.database.TokenDatabase.getInstance(context).getAllAccounts();
            for (org.tokeng.gms.database.TokenAccount account : dbAccounts) {
     ...
     */
    @SuppressWarnings("MissingPermission")
    public static synchronized LastCheckinInfo checkinFresh(Context context, org.tokeng.gms.profile.MultiDeviceRegistry.DevicePreset preset) throws IOException {
